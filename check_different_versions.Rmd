...
curr_files <- dir("mspl_files_defaults_fullrun_X2017.07.12.15.20.15_0.0.276", full.names = TRUE, recursive = TRUE)
...
```{r final_set}
final_data <- lapply(c(prev_files$mspl_files_defaults_fullrun_X2017.07.11.16.19.33_0.0.183[1], curr_files$mspl_files_defaults_fullrun_X2017.07.12.15.20.15_0.0.276[1]), function(in_file){
  tmp_env <- new.env()
  load(in_file, envir = tmp_env)
  tmp_env
})
