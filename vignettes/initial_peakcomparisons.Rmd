...
```{r cluster_mz}
indiv_loc <- list(loc_1 = filter(all_peaks, mz < 1486.119),
                  loc_2 = filter(all_peaks, (mz >= 1486.119) & (mz < 1486.121)),
                  loc_3 = filter(all_peaks, (mz >= 1486.121) & (mz < 1486.123)),
                  loc_4 = filter(all_peaks, (mz >= 1486.123)))
