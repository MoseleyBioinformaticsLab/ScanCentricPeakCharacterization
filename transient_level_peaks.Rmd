...
#' @importfrom dplyr filter, lag, mutate
...
* Write a `predict_exponential_fit` function to generate the predictions for the
search window width to find correspondent M/Z's to a query M/Z. 
