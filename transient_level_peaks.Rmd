...
* For basic peak method, the intensity should be done as a weighted average
of the intensity of two nearest points, where weight is proportional to distance
from the points
